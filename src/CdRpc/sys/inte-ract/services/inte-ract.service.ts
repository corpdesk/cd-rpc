...
import { InteRactModel } from '../models/inte-ract.model';
import { from, Observable } from 'rxjs';
import { getConnection } from 'typeorm';
import { GenericController } from "../../base/generic-controller";
import { GenericService } from "../../base/generic-service";

// export class InteRactService extends CdService {
export class InteRactService extends GenericService<InteRactModel> {
    err: string[] = []; // error messages
    b: any; // instance of InteRactService
    cdToken: string;
    serviceModel = InteRactModel;
    docName = 'InteRactService';
    sessModel;
    ...
    async create(req: Request, res: Response) {
        console.log('InteRactService::create()/01')
        const svSess = new SessionService();
        if (await this.validateCreate(req, res)) {
            const account = await this.beforeCreate(req, res);
            console.log('InteRactService::create()/account:', account)
            const serviceInput = {
                serviceInstance: this,
                serviceModel: InteRactModel,
                serviceModelInstance: this.serviceModel,
                docName: 'Create InteRact',
                dSource: 1,
            }
            const result = await this.b.create(req, res, serviceInput)
            console.log('InteRactService::create()/afterResult:', result)
            const afterResult = await this.afterCreate(req, res, result)
            console.log('InteRactService::create()/afterResult:', afterResult)
            this.b.i.app_msg = '';
    ...
    async createI(req, res, serviceInputExt: IExtServiceInput<any>): Promise<InteRactModel | boolean> {
        console.log('InteRactService::createI()/createI()/01')
        if (await this.validatecreateI(req, res, serviceInputExt)) {
            console.log('InteRactService::createI()/02')
            const account = await this.beforeCreateI(req, res, serviceInputExt);
            console.log('InteRactService::createI()/account:', account)
            const result = this.b.createI(req, res, serviceInputExt)
            const afterResult = await this.afterCreate(req, res, result)
            console.log('InteRactService::createI()/afterResult:', afterResult)
            return afterResult;
        } else {
            const r = await this.b.respond(req, res);
        }
    ...
    async validatecreateI(req, res, serviceInputExt) {
        console.log('InteRactService::validateCreateI()/01')
        let countInvalid = 0;
        // const validRequired = await this.b.validateRequired(req, res, this.cRules)
        // console.log('InteRactService::validateCreateI()/validRequired:', validRequired)
     ...
     * @returns 
     */
    async afterCreate(req, res, newBill: InteRactModel): Promise<any> {
        
    }

    async read(req: Request, res: Response, serviceInput: IServiceInput<any>): Promise<any> {
        const q = this.b.getQuery(req);
        console.log('InteRactService::getBill/q:', q);
        try {
            this.b.read$(req, res, serviceInput)
                .subscribe((r: any) => {
                    // console.log('InteRactService::read$()/r:', r)
                    this.b.i.code = 'InteRactService::Get';
                    const svSess = new SessionService();
            ...
            console.log('InteRactService::read$()/e:', e)
            this.b.err.push(e.toString());
            const i = {
                messages: this.b.err,
                code: 'InteRactService:update',
                app_msg: ''
            };
    ...
    async update(req: Request, res: Response) {
        console.log('InteRactService::update()/01');
        let q = this.b.getQuery(req);
        q = this.beforeUpdate(q);
        const serviceInput = {
            serviceModel: InteRactModel,
            docName: 'InteRactService::update',
            cmd: {
                action: 'update',
                query: q
            },
        ...
        console.log('InteRactService::update()/02')
    ...
    async updateI(req, res, q): Promise<any> {
        console.log('InteRactService::updateI()/01');
        // let q = this.b.getQuery(req);
        q = this.beforeUpdate(q);
        const serviceInput = {
            serviceModel: InteRactModel,
            docName: 'InteRactService::updateI',
            cmd: {
                action: 'update',
                query: q
            },
    ...
    async validateCreate(req: Request, res: Response) {
        console.log('InteRactService::validateCreate()/01')
        const validRequired = await this.b.validateRequired(req, res, this.cRules)
        console.log('InteRactService::validateCreate()/validRequired:', validRequired)
    ...
    //  * @param res
    //  */
    async getInteRact(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactService::getBill/q:', q);
        const serviceInput = {
            serviceModel: InteRactModel,
            docName: 'InteRactService::getBill',
            cmd: {
                action: 'find',
                query: q
            },
    ...
    getPaged(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactService::getBillCount()/q:', q);
        const serviceInput = {
            serviceModel: InteRactModel,
            docName: 'InteRactService::getBillCount',
            cmd: {
                action: 'find',
                query: q
            },
    ...
    async delete(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactService::delete()/q:', q)
        const serviceInput = {
            serviceModel: InteRactModel,
            docName: 'InteRactService::delete',
            cmd: {
                action: 'delete',
                query: q
            },
