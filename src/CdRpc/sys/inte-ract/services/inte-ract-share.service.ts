...
import { InteRactShareModel } from '../models/inte-ract-share.model';
import { from, Observable } from 'rxjs';
import { getConnection } from 'typeorm';
import { GenericController } from "../../base/generic-controller";
import { GenericService } from "../../base/generic-service";

// export class InteRactShareService extends CdService {
export class InteRactShareService extends GenericService<InteRactShareModel> {
    err: string[] = []; // error messages
    b: any; // instance of InteRactShareService
    cdToken: string;
    serviceModel = InteRactShareModel;
    docName = 'InteRactShareService';
    sessModel;
    ...
    async create(req: Request, res: Response) {
        console.log('InteRactShareService::create()/01')
        const svSess = new SessionService();
        if (await this.validateCreate(req, res)) {
            const account = await this.beforeCreate(req, res);
            console.log('InteRactShareService::create()/account:', account)
            const serviceInput = {
                serviceInstance: this,
                serviceModel: InteRactShareModel,
                serviceModelInstance: this.serviceModel,
                docName: 'Create InteRactShare',
                dSource: 1,
            }
            const result = await this.b.create(req, res, serviceInput)
            console.log('InteRactShareService::create()/afterResult:', result)
            const afterResult = await this.afterCreate(req, res, result)
            console.log('InteRactShareService::create()/afterResult:', afterResult)
            this.b.i.app_msg = '';
    ...
    async createI(req, res, serviceInputExt: IExtServiceInput<any>): Promise<InteRactShareModel | boolean> {
        console.log('InteRactShareService::createI()/createI()/01')
        if (await this.validatecreateI(req, res, serviceInputExt)) {
            console.log('InteRactShareService::createI()/02')
            const account = await this.beforeCreateI(req, res, serviceInputExt);
            console.log('InteRactShareService::createI()/account:', account)
            const result = this.b.createI(req, res, serviceInputExt)
            const afterResult = await this.afterCreate(req, res, result)
            console.log('InteRactShareService::createI()/afterResult:', afterResult)
            return afterResult;
        } else {
            const r = await this.b.respond(req, res);
        }
    ...
    async validatecreateI(req, res, serviceInputExt) {
        console.log('InteRactShareService::validateCreateI()/01')
        let countInvalid = 0;
        // const validRequired = await this.b.validateRequired(req, res, this.cRules)
        // console.log('InteRactShareService::validateCreateI()/validRequired:', validRequired)
     ...
     * @returns 
     */
    async afterCreate(req, res, newBill: InteRactShareModel): Promise<any> {
        
    }

    async read(req: Request, res: Response, serviceInput: IServiceInput<any>): Promise<any> {
        const q = this.b.getQuery(req);
        console.log('InteRactShareService::getBill/q:', q);
        try {
            this.b.read$(req, res, serviceInput)
                .subscribe((r: any) => {
                    // console.log('InteRactShareService::read$()/r:', r)
                    this.b.i.code = 'InteRactShareService::Get';
                    const svSess = new SessionService();
            ...
            console.log('InteRactShareService::read$()/e:', e)
            this.b.err.push(e.toString());
            const i = {
                messages: this.b.err,
                code: 'InteRactShareService:update',
                app_msg: ''
            };
    ...
    async update(req: Request, res: Response) {
        console.log('InteRactShareService::update()/01');
        let q = this.b.getQuery(req);
        q = this.beforeUpdate(q);
        const serviceInput = {
            serviceModel: InteRactShareModel,
            docName: 'InteRactShareService::update',
            cmd: {
                action: 'update',
                query: q
            },
        ...
        console.log('InteRactShareService::update()/02')
    ...
    async updateI(req, res, q): Promise<any> {
        console.log('InteRactShareService::updateI()/01');
        // let q = this.b.getQuery(req);
        q = this.beforeUpdate(q);
        const serviceInput = {
            serviceModel: InteRactShareModel,
            docName: 'InteRactShareService::updateI',
            cmd: {
                action: 'update',
                query: q
            },
    ...
    async validateCreate(req: Request, res: Response) {
        console.log('InteRactShareService::validateCreate()/01')
        const validRequired = await this.b.validateRequired(req, res, this.cRules)
        console.log('InteRactShareService::validateCreate()/validRequired:', validRequired)
    ...
    //  * @param res
    //  */
    async getInteRactShare(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactShareService::getBill/q:', q);
        const serviceInput = {
            serviceModel: InteRactShareModel,
            docName: 'InteRactShareService::getBill',
            cmd: {
                action: 'find',
                query: q
            },
    ...
    getPaged(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactShareService::getBillCount()/q:', q);
        const serviceInput = {
            serviceModel: InteRactShareModel,
            docName: 'InteRactShareService::getBillCount',
            cmd: {
                action: 'find',
                query: q
            },
    ...
    async delete(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactShareService::delete()/q:', q)
        const serviceInput = {
            serviceModel: InteRactShareModel,
            docName: 'InteRactShareService::delete',
            cmd: {
                action: 'delete',
                query: q
            },
