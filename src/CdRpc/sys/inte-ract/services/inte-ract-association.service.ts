...
export class InteRactAssociationService extends GenericController<InteRactAssociationModel> {
    ...
    async createI(req, res, serviceInputExt: IExtServiceInput<any>): Promise<InteRactAssociationModel | boolean> {
    ...
    //  * @param res
    //  */
    async getInteRactAssociation(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactAssociationService::getBill/q:', q);
        const serviceInput = {
            serviceModel: InteRactAssociationModel,
