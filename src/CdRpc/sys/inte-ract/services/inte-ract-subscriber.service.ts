...
import { InteRactSubscriberModel } from '../models/inte-ract-subscriber.model';
import { from, Observable } from 'rxjs';
import { getConnection } from 'typeorm';
import { GenericController } from "../../base/generic-controller";
import { GenericService } from "../../base/generic-service";

// export class InteRactSubscriberService extends CdService {
export class InteRactSubscriberService extends GenericService<InteRactSubscriberModel> {
    err: string[] = []; // error messages
    b: any; // instance of InteRactSubscriberService
    cdToken: string;
    serviceModel = InteRactSubscriberModel;
    docName = 'InteRactSubscriberService';
    sessModel;
    ...
    async create(req: Request, res: Response) {
        console.log('InteRactSubscriberService::create()/01')
        const svSess = new SessionService();
        if (await this.validateCreate(req, res)) {
            const account = await this.beforeCreate(req, res);
            console.log('InteRactSubscriberService::create()/account:', account)
            const serviceInput = {
                serviceInstance: this,
                serviceModel: InteRactSubscriberModel,
                serviceModelInstance: this.serviceModel,
                docName: 'Create InteRactSubscriber',
                dSource: 1,
            }
            const result = await this.b.create(req, res, serviceInput)
            console.log('InteRactSubscriberService::create()/afterResult:', result)
            const afterResult = await this.afterCreate(req, res, result)
            console.log('InteRactSubscriberService::create()/afterResult:', afterResult)
            this.b.i.app_msg = '';
    ...
    async createI(req, res, serviceInputExt: IExtServiceInput<any>): Promise<InteRactSubscriberModel | boolean> {
        console.log('InteRactSubscriberService::createI()/createI()/01')
        if (await this.validatecreateI(req, res, serviceInputExt)) {
            console.log('InteRactSubscriberService::createI()/02')
            const account = await this.beforeCreateI(req, res, serviceInputExt);
            console.log('InteRactSubscriberService::createI()/account:', account)
            const result = this.b.createI(req, res, serviceInputExt)
            const afterResult = await this.afterCreate(req, res, result)
            console.log('InteRactSubscriberService::createI()/afterResult:', afterResult)
            return afterResult;
        } else {
            const r = await this.b.respond(req, res);
        }
    ...
    async validatecreateI(req, res, serviceInputExt) {
        console.log('InteRactSubscriberService::validateCreateI()/01')
        let countInvalid = 0;
        // const validRequired = await this.b.validateRequired(req, res, this.cRules)
        // console.log('InteRactSubscriberService::validateCreateI()/validRequired:', validRequired)
     ...
     * @returns 
     */
    async afterCreate(req, res, newBill: InteRactSubscriberModel): Promise<any> {
        
    }

    async read(req: Request, res: Response, serviceInput: IServiceInput<any>): Promise<any> {
        const q = this.b.getQuery(req);
        console.log('InteRactSubscriberService::getBill/q:', q);
        try {
            this.b.read$(req, res, serviceInput)
                .subscribe((r: any) => {
                    // console.log('InteRactSubscriberService::read$()/r:', r)
                    this.b.i.code = 'InteRactSubscriberService::Get';
                    const svSess = new SessionService();
            ...
            console.log('InteRactSubscriberService::read$()/e:', e)
            this.b.err.push(e.toString());
            const i = {
                messages: this.b.err,
                code: 'InteRactSubscriberService:update',
                app_msg: ''
            };
    ...
    async update(req: Request, res: Response) {
        console.log('InteRactSubscriberService::update()/01');
        let q = this.b.getQuery(req);
        q = this.beforeUpdate(q);
        const serviceInput = {
            serviceModel: InteRactSubscriberModel,
            docName: 'InteRactSubscriberService::update',
            cmd: {
                action: 'update',
                query: q
            },
        ...
        console.log('InteRactSubscriberService::update()/02')
    ...
    async updateI(req, res, q): Promise<any> {
        console.log('InteRactSubscriberService::updateI()/01');
        // let q = this.b.getQuery(req);
        q = this.beforeUpdate(q);
        const serviceInput = {
            serviceModel: InteRactSubscriberModel,
            docName: 'InteRactSubscriberService::updateI',
            cmd: {
                action: 'update',
                query: q
            },
    ...
    async validateCreate(req: Request, res: Response) {
        console.log('InteRactSubscriberService::validateCreate()/01')
        const validRequired = await this.b.validateRequired(req, res, this.cRules)
        console.log('InteRactSubscriberService::validateCreate()/validRequired:', validRequired)
    ...
    //  * @param res
    //  */
    async getInteRactSubscriber(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactSubscriberService::getBill/q:', q);
        const serviceInput = {
            serviceModel: InteRactSubscriberModel,
            docName: 'InteRactSubscriberService::getBill',
            cmd: {
                action: 'find',
                query: q
            },
    ...
    getPaged(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactSubscriberService::getBillCount()/q:', q);
        const serviceInput = {
            serviceModel: InteRactSubscriberModel,
            docName: 'InteRactSubscriberService::getBillCount',
            cmd: {
                action: 'find',
                query: q
            },
    ...
    async delete(req: Request, res: Response) {
        const q = this.b.getQuery(req);
        console.log('InteRactSubscriberService::delete()/q:', q)
        const serviceInput = {
            serviceModel: InteRactSubscriberModel,
            docName: 'InteRactSubscriberService::delete',
            cmd: {
                action: 'delete',
                query: q
            },
