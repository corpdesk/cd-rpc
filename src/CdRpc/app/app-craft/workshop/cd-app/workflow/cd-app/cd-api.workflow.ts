...
export class CdApiWorkFlow {
  ...
  upgradeWorkFlow(
    ...
    if (!cdApiDir) {
      throw new Error('CdApi directory path is not defined in the descriptor');
    }
  ...
  async getRoadMap(
    ...
    return {
      name: 'cd-api roadmap',
      type: 'dev-roadmap',
      description: 'Initial roadmap for cd-api auto-development, starting from version 0.8.0',
      versionTag: 0,
      version: '0.8.0',
