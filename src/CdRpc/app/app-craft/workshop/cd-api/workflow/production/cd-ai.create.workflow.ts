...
import { MOD_CRAFT_OUTPUT_API_DIR, MOD_CRAFT_OUTPUT_MODULE_DIR } from "../../../../models/default.model.js";
            ...
            tasks: [
              ...
              },
              {
                ...
                cdRequest: {
                  ...
                  args: {
                    ...
                    moduleType: "cd-api",
                    path: `${MOD_CRAFT_OUTPUT_API_DIR}/${cdModule.name}`, // or "~/cd-ai",
                  },
                },
                onResult: [
                  {
              ...
              },
              {
                ...
                cdRequest: {
                  ...
                  args: {
                    moduleDir: `${MOD_CRAFT_OUTPUT_API_DIR}/${cdModule.name}`,
                  },
                },
                onResult: [
                  {
