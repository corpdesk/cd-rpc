...
export const cdRfcVersionControl: VersionControlDescriptor = {
  name: 'CdRfc',
  repository: {
    name: 'cd-rfc',
    url: 'https://github.com/corpdesk/cd-rfc.git',
    type: 'git',
    enabled: true,
    isPrivate: false,
    credentials: {
    ...
    directories: [
       ...
       * It is used to scafold the module for the cd-rfc.
       */
      {
        name: 'workshopModuleOutput',
        environment: envWorkshop,
        path: '/home/emp-12/cd-cli/dist/CdCli/app/app-craft/workshop/cd-module/output/cd-rfc',
       ...
       */
      {
        ...
        path: '/home/emp-12/cd-projects/cd-api/src/CdApi/app/cd-rfc-test-bed',
