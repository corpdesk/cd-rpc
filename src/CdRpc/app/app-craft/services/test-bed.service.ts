...
// import { GitOctokitController } from '../../cd-auto-git/controllers/octokit.controller.js';
...
export class TestBedService {
  ...
  //   this.logger.logDebug('TestBedService::create()/01');
  //   const cdObjType = inferCdObjType(this.constructor.name);
  //   this.logger.logDebug(`TestBedService::create()/cdObjType:${cdObjType}`);
  ...
  //     },
  //   );
  //   this.logger.logDebug(`TestBedService::create()/descriptor: ${inspect(descriptor, { depth: 3 })}`);
  //   this.logger.logDebug(`TestBedService::create()/workflowModel: ${inspect(workflowModel, { depth: 4 })}`);
  ...
  //       this.logger.logDebug(`📤 Git Push Output:\n${pushResult}`);
  ...
  //     this.logger.logDebug(`🧹 Cleaning target directory: ${testBedDir}`);
  //     try {
  ...
  //     this.logger.logDebug(`📥 Executing Git clone:\n→ ${cloneCommand}\n→ In: ${parentDir}`);

  //     try {
  //       const cloneResult = await executeCommand(cloneCommand, parentDir);
  //       this.logger.logDebug(`📥 Clone output:\n${cloneResult}`);
  //       return cdFx(
  ...
  //     this.logger.logDebug(`📁 TestBedService::pullToTestBed() → Using path: ${repoPath}`);
  ...
  //       this.logger.logDebug(`🔗 Remote origin: ${remoteUrl}`);
  //     } catch {
  ...
  //       this.logger.logDebug(`📥 Pull Result:\n${pullResult}`);
  //     } catch (e: any) {
  ...
  //         this.logger.logDebug(`ℹ️ No new changes detected during pull.`);
  //         return cdFx(CdFxStateLevel.Info, `✅ Pull completed. No changes in: ${repoPath}`);
  //       } else {
  //         this.logger.logDebug(`🆕 Files changed:\n${changes}`);
  ...
  //   repoName: string,
  // ): Promise<CdFxReturn<null | CdAssertReturn[]>> {
  //   this.logger.logDebug('Starting TestBedService::update()');
  //   this.logger.logDebug(`TestBedService::update()/actionTargetName: ${actionTargetName}`);
  //   this.logger.logDebug(`TestBedService::update()/moduleName: ${moduleName}`);
  //   this.logger.logDebug(`TestBedService::update()/oEnv: ${oEnv}`);
  //   this.logger.logDebug(`TestBedService::update()/repoName: ${repoName}`);
  //   const cdObjType = inferCdObjType(this.constructor.name);
  //   const runner = new CiCdRunnerService();
  //   const { descriptor, workflowModel } = await runner.loadModuleDescriptorAndWorkflow(
  ...
  //   repoName: string,
  // ): Promise<CdFxReturn<null | CdAssertReturn[]>> {
  //   this.logger.logDebug('Starting TestBedService::delete()');
  //   this.logger.logDebug(`TestBedService::delete()/actionTargetName: ${actionTargetName}`);
  //   this.logger.logDebug(`TestBedService::delete()/moduleName: ${moduleName}`);
  //   this.logger.logDebug(`TestBedService::delete()/oEnv: ${oEnv}`);
  //   this.logger.logDebug(`TestBedService::delete()/repoName: ${repoName}`);
  //   const cdObjType = inferCdObjType(this.constructor.name);
  //   const runner = new CiCdRunnerService();
  //   const { descriptor, workflowModel } = await runner.loadModuleDescriptorAndWorkflow(
  ...
  //   repoName: string,
  // ): Promise<CdFxReturn<null | CdAssertReturn[]>> {
  //   this.logger.logDebug('Starting TestBedService::test()');
  //   this.logger.logDebug(`TestBedService::test()/actionTargetName: ${actionTargetName}`);
  //   this.logger.logDebug(`TestBedService::test()/moduleName: ${moduleName}`);
  //   this.logger.logDebug(`TestBedService::test()/oEnv: ${oEnv}`);
  //   this.logger.logDebug(`TestBedService::test()/repoName: ${repoName}`);
  //   const cdObjType = inferCdObjType(this.constructor.name);
  //   const runner = new CiCdRunnerService();
  //   const { descriptor, workflowModel } = await runner.loadModuleDescriptorAndWorkflow(
  //     DevModeAction.TEST,
  ...
  //   testTasks?: string,
  // ): Promise<CdFxReturn<null | CdAssertReturn[]>> {
  //   this.logger.logDebug('Starting TestBedService::upgrade()');
  //   this.logger.logDebug(`TestBedService::upgrade()/actionTargetName: ${actionTargetName}`);
  //   this.logger.logDebug(`TestBedService::upgrade()/moduleName: ${moduleName}`);
  //   this.logger.logDebug(`TestBedService::upgrade()/oEnv: ${oEnv}`);
  //   this.logger.logDebug(`TestBedService::upgrade()/repoName: ${repoName}`);
  //   this.logger.logDebug(`TestBedService::upgrade()/version: ${version}`);
  //   this.logger.logDebug(`TestBedService::upgrade()/testTasks: ${testTasks}`);
  ...
  //   try {
  //     this.logger.logDebug(`TestBedService::createModuleDirectories()/moduleDir: ${moduleDir}`);
  ...
  //     this.logger.logDebug(`TestBed::addModuleToEntities() → cdApiRoot.path: ${cdApiRoot.path}`);

  //     const entitiesJsonPath = path.join(cdApiRoot.path, 'config', 'module-entities.json');

  //     this.logger.logDebug(`TestBed::addModuleToEntities() → Target JSON Path: ${entitiesJsonPath}`);
